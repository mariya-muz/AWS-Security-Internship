...
-nAWS cloud security project using IAM roles, WAF for ALB protection, CloudTrail and CloudWatch logging, multi-region backups, and AWS Open Data ingestion into S3 to demonstrate secure, monitored, and resilient cloud infrastructure practices.
---
